    ...
    <footer className="bg-slate-400">
      <div className="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
          ...
          <div>
            <Link to={"/home"}>
              <h2 className="font-blach sm:text-xl text-sm text-left hover:bg-transparent uppercase text-brand-blue tracking-tighter w-full font-oswald font-bold flex items-center justify-start">
                <img
                  className="w-10 h-10"
                  src="https://firebasestorage.googleapis.com/v0/b/realestate-b0838.appspot.com/o/logo1.png?alt=media&token=021ec8f2-a6f0-4140-aace-468b2372d08a"
                  alt="logo"
                />
                <span>Prime Living</span>
              </h2>
            </Link>
          </div>
        ...
        <p className="text-xs text-brand-blue font-heading">
          &copy; 2024. Prime Living. All rights reserved.
        </p>
      </div>
    </footer>
  );
